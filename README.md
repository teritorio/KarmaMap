...
`--user-indicators` pass adds two non-partitioned user datasets. See
[API.md](API.md) for the output layout, schemas, and how clients access the
changes and users data.
...
Passes 1-3 are independent of the optional user-indicator pass (see
[API.md](API.md)).
...
| `--user-indicators` | Also run the user-indicator pass (see [API.md](API.md)); independent of passes 1-3 |
